...
namespace LT.DigitalOffice.ProjectService.Data.UnitTests
{
    public class TaskRepositoryTests
    {
        ...
        public void ExceptionWhenThereIsNotTask()
        {
            ...
            Assert.Throws<NotFoundException>(() => _repository.Get(_taskId, true));

            Assert.Throws<NotFoundException>(() => _repository.Edit(_repository.Get(_taskId, true), _patchDbTask));
        }
