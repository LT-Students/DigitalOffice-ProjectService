...
namespace LT.DigitalOffice.ProjectServiceUnitTests.Repositories
{
    internal class GetProjectUsersRepositoryTests
    {
        ...
        {
            var result = _repository.GetProjectUsers(Guid.NewGuid(), true);
        ...
        {
            var result = _repository.GetProjectUsers(_projectId, true);
        ...
        {
            var result = _repository.GetProjectUsers(_projectId, false);
