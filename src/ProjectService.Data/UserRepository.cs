...
namespace LT.DigitalOffice.ProjectService.Data
{
  public class UserRepository : IUserRepository
  {
    ...
    public bool DoExist(params Guid[] ids)
    {
    ...
    public List<Guid> DoExist(Guid projectId, List<Guid> ids)
    {
      return _provider.ProjectsUsers.Where(pu => pu.ProjectId == projectId && ids.Contains(pu.UserId) && pu.IsActive).Select(pu => pu.UserId).ToList();
    }
  }
}
